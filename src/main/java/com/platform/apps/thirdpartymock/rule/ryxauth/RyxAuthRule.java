...
public abstract class RyxAuthRule {

	public static Logger logger = LoggerFactory.getLogger(RyxAuthRule.class);
	...
	public void init() {
		...
		try {
			File reqFile = new File(xmlPath + "ryxauth" + File.separator + name + "-Req.xml");
			File resFile = new File(xmlPath + "ryxauth" + File.separator + name + "-Res.xml");
	...
	public Map<String, String> getInfos() {
		...
		try {
			...
			File resDefFile = new File(xmlPath + "ryxauth" + File.separator + name + "-Res-default.xml");
	...
	public void setResponse(String name, String response) {
		...
		try {
			...
			File file = new File(xmlPath + "ryxauth" + File.separator + name + "-Res.xml");
		...
		SAXReader saxReader = new SAXReader();
		try {
			docResponse = saxReader.read(new File(xmlPath + "ryxauth" + File.separator + name + "-Res.xml"));
		} catch (DocumentException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public boolean setDefault(String name) {
		...
		try {
			is = new FileInputStream(xmlPath + "ryxauth" + File.separator + name + "-Res-default.xml");
			os = new FileOutputStream(xmlPath + "ryxauth" + File.separator + name + "-Res.xml");
